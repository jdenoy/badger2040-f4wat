...
try:
    open("badge_image.bin", "rb").readinto(BADGE_IMAGE)
except OSError:
    try:
        import badge_image
...
company = badge.readline()        # "ligne 1"
name = badge.readline()           # "ligne 2"
detail1_title = badge.readline()  # "ligne 3"
detail1_text = badge.readline()   # "ligne 4"
detail2_title = badge.readline()  # "ligne 5"
detail2_text = badge.readline()   # "ligne 6"
